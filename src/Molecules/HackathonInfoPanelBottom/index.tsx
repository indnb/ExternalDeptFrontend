  ...
  return (
    <div className='w-[100vw] flex justify-center mt-[-50px] max-lg:mt-[-0px] max-w-[1800px]'>
      <div className='w-[47vw] text-center'>
        <h1 className={` h-full text-left ${fontSize ? (language == 'ua' ? "text-[calc(37/1552*100vw)]  max-lg:text-[14px] min-xl2:text-[36px]" : "text-[calc(33/1552*100vw)]  max-lg:text-[12px] min-xl2:text-[30px]")
