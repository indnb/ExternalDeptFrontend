...
export const RegistrationHeader: React.FC<RegistrationHeaderProps> = ({ title, onClose, selectedForm }) => {
  ...
  return (
    <div className="relative  flex items-center w-full  p-2">
      <div className="absolute w-[100vw]  flex  justify-center items-center">
        <div className="max-w-[1800px] flex items-start justify-start w-[98vw]  max-2xl:w-[0px] ml-[0px] left-[0px] max-lg:hidden  ">
