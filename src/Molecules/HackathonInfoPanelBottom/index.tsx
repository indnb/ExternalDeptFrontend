  ...
  return (
    <div className='w-[100vw] flex justify-center mt-[-50px] max-lg:mt-[-0px] max-w-[1800px]'>
      <div className='w-[47vw] text-center'>
        <h1 className={` h-full text-left ${fontFamily ? "font-kharkiv" : "font-montserrat"}
${fontSize ? (language == 'ua' ? "text-[calc(43/1552*100vw)]  max-sm:text-[18px] min-xl2:text-[43px]" : "text-[calc(43/1552*100vw)]  max-sm:text-[18px] min-xl2:text-[43px]")
      ...
      <div className={`w-[47vw] ${contrast ? "text-[#414141]" : "text-[#203C8F]"} 
${fontFamily ? "font-kyivSerif font-[250] " : "font-kyivSans"}   max-lg:h-full
     ${language == `ua` ? "min-xl2:text-[266px] text-[calc(250/1552*100vw)]"
          :
          "min-xl2:text-[240px] text-[calc(190/1552*100vw)]"}
