...
export const ItemCategoryHackathon = ({ img, description, name }: { img: string, description: string, name: string }) => {
  ...
  return (
    <div className='text-center flex items-center justify-center w-[83vw]  border-t-2 border-black  min-xl2:w-[1540px]'>
      <div className='text-center w-[95%]  max-[850px]:mb-[12px] max-[1300px]:mt-[25px] max-[1300px]:mb-[25px] mb-[50px] mt-[50px] max-[850px]:mt-[12px] flex justify-between   
        items-center max-[850px]:flex-col '>
        <div className='text-center  items-center  max-[850px]:w-auto w-[40%] flex  justify-start'>
          <Image
        ...
        <h1 className={`max-[850px]:mt-[11px] min-xl2:text-[32px] max-[850px]:w-[auto] w-[39%] font-montserrat font-normal ${fontSize ? "text-[calc(27/1552*100vw)] max-[550px]:text-[14px]" : "text-[calc(23/1552*100vw)] max-[550px]:text-[10px]"} text-black`}>
