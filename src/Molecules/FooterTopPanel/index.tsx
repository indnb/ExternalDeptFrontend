...
export const FooterTopPanel = () => {
  ...
  return (
    <div className=' w-[93vw]  max-lg:h-[80px] h-[273px] flex items-center justify-between '>
      <div className='w-[455px] max-lg:w-[171px] max-lg:h-[52px]  flex h-[157px] text-left items-center '>
        <Image src={Dyikt} className='w-[141px] h-[141px] max-lg:h-[46px] max-lg:w-[46px] filter grayscale invert brightness-50' alt="" />
        <div className={`ml-[24px]   text-[white]  text-[28px] max-lg:text-[12px] max-lg:ml-[9px] leading-tight flex flex-col justify-center items-center 
