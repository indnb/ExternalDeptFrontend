...
export const RegisterInfo = () => {
  ...
  return (
    ...
    <div className='w-[100vw] flex items-center justify-center'>
      <div className={`flex h-[140px] w-[449px] rounded-[16px] text-[16px] justify-center items-center text-center text-black
       ${contrast ? "border-[#414141]" : "border-mainBlue"}
        border-[2px]  max-lg:text-[14px] max-lg:h-[100px] max-lg:w-[349px] max-lg:border-[1.5px]`}>
